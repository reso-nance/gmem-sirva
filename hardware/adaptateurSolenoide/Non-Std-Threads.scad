...
union(){
    translate([0,0,6]) metric_thread (diameter=8, pitch=3, length=8);
        //cylinder(h=6, r1=1.6, r2=1.6, center=true);
    difference() {
        translate([0,0,3]) cylinder(h=6, r1=4, r2=4, center=true);
        cylinder(h=4, r1=1.6, r2=1.6, center=true);
    }
}

translate([20,0,7.5]) difference(){
     cylinder(h=15, r1=6, r2=6, center=true);
    translate([0,0,10]) cylinder(h=20, r1=5, r2=5, center=true);
    translate([0,0,-6]) cylinder(h=3, r1=3, r2=4, center=true);
    translate([-0,0,-20]) metric_thread (diameter=8, pitch=3, length=20+1,internal=true);
};
